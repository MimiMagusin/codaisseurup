...
Event.create!(name: "Music Poetry Candlelight Night", description: "Share your accoustic music and poetry", location: "In the building", starts_at: "2017-9-5 15:00:00", active:true, user: miriam )
